...
happyExpList = Happy_Data_Array.listArray (0,66) ([5888,32768,11,0,0,8,152,19457,128,16422,0,0,23,0,49152,997,0,0,0,0,9728,64,7936,32768,49167,2052,57344,12291,513,152,19457,128,16422,4864,32,12160,4096,0,0,0,0,64,0,0,16,7168,0,14,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseCalc","ListStatement","Statement","ListExp","Exp","int","var","printString","print","read","loop","endLoop","'='","'+'","'-'","'*'","'^'","'/'","'('","')'","%eof"]
        bit_start = st * 23
        bit_end = (st + 1) * 23
...
action_17 (12) = happyShift action_13
...
action_19 (7) = happyGoto action_32
...
action_21 (9) = happyShift action_12
...
action_24 (20) = happyShift action_23
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenPrintString _ -> cont 10;
	TokenPrint _ -> cont 11;
	TokenRead _ -> cont 12;
	TokenLoop _ -> cont 13;
	TokenEndLoop _ -> cont 14;
	TokenEq _ -> cont 15;
	TokenPlus _ -> cont 16;
